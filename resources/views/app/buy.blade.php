...
@section('content')
<div class="top-title">
 <div><span class="muted" style="font-size:11px">BLUEPING STORE</span><h2>سرویس مناسب شرایطت رو انتخاب کن</h2><div class="muted">Standard برای استفاده اقتصادی و روزمره · Pro برای کیفیت و پایداری بالاتر.</div></div>
