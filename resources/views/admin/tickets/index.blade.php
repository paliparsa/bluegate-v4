...
@section('content')
<div class="admin-hero"><div><div class="admin-kicker">SUPPORT</div><h2 style="margin:7px 0 6px">Support Desk</h2><div class="muted">BlueGate Admin Operations</div></div><span class="pill">ADMIN</span></div>
